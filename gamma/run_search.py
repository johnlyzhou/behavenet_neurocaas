...
def main(args):
    ...
    gamma_start = hparams['ps_vae.gamma'][0]
    ...
    plot_and_film_best(lab, expt, animal, session, label_names, experiment_name, n_ae_latents, trials,
                       beta=beta_start, gamma=gamma_start, model_class=model_class, n_clusters=n_clusters,
